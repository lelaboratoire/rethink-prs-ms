...
<small><em>
This manuscript
([permalink](https://lelaboratoire.github.io/rethink-prs-ms/v/9eeea5b70fa3bf20c3f11778bd72c79034163674/))
was automatically generated
from [lelaboratoire/rethink-prs-ms@9eeea5b](https://github.com/lelaboratoire/rethink-prs-ms/tree/9eeea5b70fa3bf20c3f11778bd72c79034163674)
on December 13, 2019.
</em></small>
...
The Multifactor Dimensionality Reduction (MDR) method is one such nonparametric framework that addresses these challenges and has been extensively applied to detect nonlinear complex GxG interactions associated with individual disease [@E26QhGxD; @1BqLrlGsj]. 
...
Model-Based Multifactor Dimensionality Reduction (MB-MDR) was formulated as a flexible GxG detection framework for both dichotomous and continuous traits [@kN4MaLuT; @16AnEAMje].
...
The significance level of each combination of SNPs on a given dataset is obtained by applying on that dataset the MB-MDR software [@S6nj6BFK; @16AnEAMje] v.4.4.1.
